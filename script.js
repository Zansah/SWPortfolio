...
// This is the sliding page from the top when on computer screens
// Vertical when on regular screen
...
// Close on clicking outside (optional)
document.addEventListener('click', (e) => {
  if (slidingPage.classList.contains('active') && !slidingPage.contains(e.target) && e.target !== hamburger && !hamburger.contains(e.target)) {
    slidingPage.classList.remove('active');
  }
});